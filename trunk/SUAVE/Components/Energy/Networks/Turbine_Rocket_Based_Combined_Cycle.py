...
# ----------------------------------------------------------------------
## @ingroup Components-Energy-Networks
class Turbine_Rocket_Based_Combined_Cycle(Propulsor):
	...
	""" Calculate thrust given the current state of the vehicle
        ...
        thrust_2                  = self.thrust_2 #turbojet
        ...
        sj_mode = np.logical_and(Mo >= M_transition2, Mo <= M_transition3)
        rk_mode = Mo > M_transition3
        ...
        rocket.working_fluid = self.working_fluid
        rocket.combustor = combustor
        rocket.nozzle = core_nozzle
        rocket.thrust = thrust_3
                
        rocket_results = Data()
        rocket_results = rocket.evaluate_thrust(state)
        ...
        F_sum[rk_mode] = rocket_results.thrust_force_vector[rk_mode]
        ...
        mdot_f_sum[rk_mode] = rocket_results.vehicle_mass_rate[rk_mode]
        ...
        Isp_sum[rk_mode] = rocket_results.specific_impulse[rk_mode]
        ...
        f_sum[rk_mode] = rocket_results.f[rk_mode]
        ...
        TSFC_sum[rk_mode] = rocket_results.tsfc[rk_mode]
        ...
        Fsp_sum[rk_mode] = rocket_results.fsp[rk_mode]
